...
export default function ProfilePage({
  ...
  const [notifications, setNotifications] = useState(
    () => loadAccountPreferences().notifications,
  );
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                      ...
                      <p className="mt-1 text-sm text-slate-600">
                        This is the primary address saved to your account.
                      </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  These preferences are shared with your Settings page.
                </p>
                  ...
                  {[
                    {
                      key: "orderUpdates",
                      label: "Order Updates",
                      desc: "Get notified about order status",
                    },
                    {
                      key: "promotions",
                      label: "Promotions",
                      desc: "Receive special offers",
                    },
                    {
                      key: "newsletter",
                      label: "Newsletter",
                      desc: "Monthly updates & news",
                    },
                  ].map((item) => (
                    <label
                      key={item.key}
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`w-12 h-6 rounded-full transition relative ${notifications[item.key] ? "bg-pink-500" : "bg-gray-300"}`}
                      >
                        <div
                          className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition ${notifications[item.key] ? "left-7" : "left-1"}`}
                        ></div>
                      </div>
                    </label>
                  ))}
          ...
          <div className="space-y-4">
            ...
            {userReviews.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-8 text-center">
                ...
                <p className="text-gray-500 mb-4">
                  Purchase items and share your thoughts!
                </p>
                <Link
                  to="/"
                  className="inline-flex items-center gap-2 bg-pink-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-pink-600 transition"
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Password updates and account deletion are handled from your
                dedicated settings screen so the profile page stays focused on
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                <div className="flex items-center gap-2 text-emerald-700">
                  <BadgeCheck size={18} />
                  <span className="font-medium">Security handled honestly</span>
                </div>
                <p className="mt-2 text-sm leading-6 text-emerald-800">
                  Two-factor authentication is not turned on yet because there
                  is no live verification-code system behind it. Until then, the
                  profile shows clear status instead of a fake enable button.
                </p>
              </div>
            </div>
